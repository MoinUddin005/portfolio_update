        ...
        <div className=" mx-auto pt-16 -pb-10 max-w-7xl">
          ...
          <div className=" text-[0.92rem] md:text-base md:text-md lg:text-lg xl:text-xl mx-auto font-light dark:text-white text-gray-900 ">
            <p className="mt-6 mb-12 leading-10 font-normal">
              I am full Stack developer who develops modern, reactive, and
              ...
              Experience in React.js typescript next.js Bootstrap
              tailwind,Node.js MongoDB and state management like Redux with
              proficiency in web technologies like HTML5, CSS3, and JavaScript,
              building large-scale web applications, design constraints on the
              web, and building responsive user interfaces.{" "}
              <span className="inline-flex items-baseline">
                <Image
                  src={Flash}
                  alt="rocket"
            ...
            <p className="">
              ...
              <span className="text-red-700 font-bold">GMail</span>{" "}
                ...
                <b>moin368892@gmail.com</b>
              {" "}
              or <span className="text-blue-700 font-bold">LinkedIn</span>{" "}
              <a
                href="https://www.linkedin.com/in/moin-uddin-b83b30215/"
              ...
              <a
                href="https://www.facebook.com/moinuddin.niloy"
                target="blank"
                rel="noopener noreferrer"
